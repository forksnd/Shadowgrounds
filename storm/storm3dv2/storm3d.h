...
private:
    ...
    SDL_Window* window;			// Renderwindow-handle
...
public:
    ...
    // Creation/delete
    Storm3D(SDL_Window* window, bool no_info = false, frozenbyte::filesystem::FilePackageManager *fileManager = 0, IStorm3D_Logger *logger = 0);
    ~Storm3D();
